...
<!-- 						</button> -->
				...
				<c:if test="${msg == null}">
					<form:form name='passwordRecoveryDTO' id="passwordRecoveryDTO" modelAttribute="passwordRecoveryDTO"
						action="${pageContext.request.contextPath}/password_recovery" method='POST'>
						<h5><spring:message code="label.recoverPassword.title" /></h5>
				...
				<div class="form-group">
						<span>
							<a href="${pageContext.request.contextPath}/login" class="forgot-password align-left">
							<spring:message code="label.signIn" />
			            	</a>
						</span>
						<span style="float:right">
							<a href="${pageContext.request.contextPath}/registration" class="forgot-password align-right">
